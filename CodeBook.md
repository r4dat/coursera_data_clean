...
**Mean of variable by Subject/ID combination. E.g 1/Walking 'mean_tBodyAcc.mean.X' is the mean of the 52 observations from subject 1, activity walking of the variable 'tBodyAcc.mean.X'**  
Type: Numeric  
